from .views import BlogCreateView,BlogDetailView,BlogPostDeleteView,BlogPostListingAPIView,BlogUpdateView,CommentListView
...
urlpatterns = [
    ...
    # path('', BlogPostListingAPIView, name='blog_list'),
